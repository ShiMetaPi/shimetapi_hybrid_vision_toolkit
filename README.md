...
- **Metavision SDK**：事件处理算法（`metavision-openeb`）
...
运行`hv_camera_metavision_sample`示例程序
```bash
# 进入示例程序目录
...
运行`metavision_sdk_test`示例程序
```bash
# 使用metavision打开相机需要先安装我们的相机插件
